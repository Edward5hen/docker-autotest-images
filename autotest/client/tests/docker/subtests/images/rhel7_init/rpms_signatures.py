...
Test rpms on rhel7-init container are signed correctly

Operational Detail
----------------------
#. Load image rhel7-init
#. Run image rhel7-init
...
*   Clean host without rhel7_init container ever installed
"""
...
class rpms_signatures(rhel7_init_base):
